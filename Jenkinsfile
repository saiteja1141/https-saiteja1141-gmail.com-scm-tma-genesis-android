	...
	try {
		...
		stage('Version') {
	          ...
	          dir('jenkinsnew') {
		       ...
		       sh 'pwd'
		      // sh 'ls'
		        File readConfigFile = new File('/var/jenkins_home/workspace/updateVersion/jenkinsnew/https-saiteja1141-gmail.com-scm-tma-genesis-android/verifyJenkins/gradle/configurations.gradle')
